const ProjectData = {
    pwm: {
        title: 'PWM',
        github: 'https://github.com/trimclain/pwm',
        description:
            'PWM is a simple CLI Password Manager written in Python. It uses cryptography and its Fernet encryption. This was my first big project in python.',
    },
    ytd: {
        title: 'YTD',
